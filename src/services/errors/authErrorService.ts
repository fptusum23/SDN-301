...
export class AuthErrorService {
  ...
  userBlocked() {
    return new AuthException('user_blocked', ERROR_MESSAGE.USER_BLOCK.message, ERROR_MESSAGE.USER_BLOCK.code)
  }
  userHasBeenDeleted() {
    return new AuthException('user_deleted', ERROR_MESSAGE.ACCOUNT_HAS_BEEN_DELETED.message, ERROR_MESSAGE.ACCOUNT_HAS_BEEN_DELETED.code)
  }
